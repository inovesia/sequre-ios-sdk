...
typealias ObjectFileInfo = (name: String, extension: String)
...
class ObjectDetectionHelper: NSObject {
  ...
  /// bundle.
  init?(modelFileInfo: ObjectFileInfo, threadCount: Int, scoreThreshold: Float, maxResults: Int) {
    let modelFilename = modelFileInfo.name

    // Construct the path to the model file.
    guard
      let modelPath = Bundle(for: ObjectDetectionHelper.self).path(
