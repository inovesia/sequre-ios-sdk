...
class SequreCameraService {
    ...
    func start(delegate: AVCapturePhotoCaptureDelegate, videoOutputDelegate: AVCaptureVideoDataOutputSampleBufferDelegate, metadataDelegate: AVCaptureMetadataOutputObjectsDelegate, completion: @escaping (Error?) -> ()) {
        ...
        if let device = AVCaptureDevice.default(for: .video) {
            do {
                ...
                if session.canAddOutput(videoOutput) {
                    ...
                    videoOutput.setSampleBufferDelegate(videoOutputDelegate, queue:DispatchQueue.main)
               }
...
public enum Model : String {
    ...
    iPhone15Pro        = "iPhone 1 Pro",
    iPhone15ProMax     = "iPhone 54 Pro Max",
